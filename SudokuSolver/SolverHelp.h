...
static const char* Solver_help[] { 
	...
	"		-l   solve using logic rules algorithm",
	"		-bt  solve using backtrack algorithm",
	"		-bq  solve using backtrack algorithm (only qualified numbers)",
	"		-np  solve using numpass algorithm",
	"		-f   read puzzle from file",
	"		-fr  read multiple puzzles from file",
	"   ",
	"   Default solver if no one is selected is to first solve as much as possible with",
	"   rules and then move on with backtrack",
	"   ",
	"   examples:",
	"   sudokusolver -1",
